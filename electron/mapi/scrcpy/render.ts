...
const spawnShell = async (
    ...
    option.env["SCRCPY_FONT_PATH"] =
        await extraResolveWithPlatform("scrcpy/font.ttf");
    option.env["SCRCPY_ICON_ROOT_PATH"] =
        await extraResolveWithPlatform("scrcpy");
    option.env["SCRCPY_SERVER_PATH"] = await extraResolveWithPlatform(
