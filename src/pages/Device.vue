...
> | null>(null);
const wirelessPairingDialog = ref<InstanceType<
    typeof DeviceWirelessPairingDialog
> | null>(null);
const pairingCodeDialog = ref<InstanceType<
    typeof DevicePairingCodeDialog
> | null>(null);
...
<template>
    ...
    >
        ...
        >
            ...
            <div class="mr-5">
                <a
                    target="_blank"
                    class="text-red-500"
                    href="https://linkandroid.com/forum"
                >
        ...
        <div class="px-8">
            ...
            <div v-else class="flex flex-wrap">
                <div
                    v-for="(r, rIndex) in filterRecords"
                    :key="rIndex"
    ...
    <DeviceWirelessPairingDialog
        ref="wirelessPairingDialog"
        @update="doRefresh"
    />
