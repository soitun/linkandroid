...
const filterAppRecords = computed(() => {
    ...
    return appRecords.value.filter((a) => {
        return (
            ...
            a.id.toLowerCase().includes(keywords)
        );
    });
});
            ...
            <div class="flex flex-col h-full">
                ...
                >
                    <div v-for="a in filterAppRecords">
                        <div
                            class="border border-solid border-gray-200 rounded-lg mb-2 p-2 flex items-center"
                        >
                            ...
                            <div
                                class="text-sm truncate flex-grow text-gray-500"
                            >
                                {{ a.id }}
                            </div>
                            <div>
