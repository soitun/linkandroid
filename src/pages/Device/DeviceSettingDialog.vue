            ...
            <div class="overflow-y-auto p-5" style="height: calc(80vh - 200px)">
                <div>
                    ...
                    <div class="flex mb-3">
                        ...
                        <div class="">
                            <SettingItemYesNoDefault
                                v-model="formData.previewImage"
                            />
                        </div>
                    </div>
                    <div class="flex mb-3">
                        <div class="flex-grow">
                            {{ $t("device.videoBitRate") }}
                        </div>
                        <div class="">
                            <a-input
                                ...
                                size="small"
                                :placeholder="
                                    $t('device.emptyConfigPlaceholder')
                                "
                            />
                        </div>
                    </div>
